...
const translations = {
    'zh-CN': {
        ...
        'logs.system.title': '系统日志',
        'logs.request.title': '请求日志',
        'logs.request.refresh': '刷新',
        'logs.request.downloadCsv': '导出 CSV',
        'logs.request.downloadJson': '导出 JSON',
        'logs.request.loadFailed': '加载请求日志失败',
        'logs.request.downloadFailed': '导出请求日志失败',
        'logs.request.stats.total': '总请求',
        'logs.request.stats.success': '成功',
        'logs.request.stats.failed': '失败',
        'logs.request.stats.retry': '重试请求',
        'logs.request.stats.avgDuration': '平均耗时',
        'logs.request.stats.totalTokens': '总 Token',
        'logs.request.status.all': '全部状态',
        'logs.request.status.running': '进行中',
        'logs.request.status.success': '成功',
        'logs.request.status.error': '失败',
        'logs.request.filters.provider': '按 Provider 筛选',
        'logs.request.filters.account': '按账号筛选',
        'logs.request.filters.search': '搜索 requestId/模型/路径/错误',
        'logs.request.table.detail': '详情',
        'logs.request.table.status': '状态',
        'logs.request.table.account': '账号',
        'logs.request.table.provider': 'Provider',
        'logs.request.table.model': '模型',
        'logs.request.table.startedAt': '开始时间',
        'logs.request.table.endedAt': '结束时间',
        'logs.request.table.duration': '耗时',
        'logs.request.table.tokens': 'Token',
        'logs.request.table.retryCount': '重试',
        'logs.request.empty': '暂无请求日志',
        'logs.request.detail.requestId': '请求 ID',
        'logs.request.detail.path': '请求路径',
        'logs.request.detail.clientIp': '客户端 IP',
        'logs.request.detail.modelRequested': '请求模型',
        'logs.request.detail.modelActual': '实际模型',
        'logs.request.detail.upstreamStatus': '上游状态码',
        'logs.request.detail.tokens': 'Token (输入/输出/总计)',
        'logs.request.detail.bytes': '字节 (请求/响应)',
        'logs.request.detail.fallback': '是否 Fallback',
        'logs.request.detail.error': '错误信息',
        'logs.request.detail.noAttempts': '暂无重试记录',
        'logs.request.detail.attemptNo': '尝试',
        'logs.request.detail.startedAt': '开始',
        'logs.request.detail.endedAt': '结束',
        'logs.request.detail.yes': '是',
        'logs.request.detail.no': '否',
    ...
    'en-US': {
        ...
        'logs.request.refresh': 'Refresh',
        'logs.request.downloadCsv': 'Export CSV',
        'logs.request.downloadJson': 'Export JSON',
        'logs.request.loadFailed': 'Failed to load request logs',
        'logs.request.downloadFailed': 'Failed to export request logs',
        'logs.request.stats.total': 'Total Requests',
        'logs.request.stats.success': 'Success',
        'logs.request.stats.failed': 'Failed',
        'logs.request.stats.retry': 'Retried Requests',
        'logs.request.stats.avgDuration': 'Avg Duration',
        'logs.request.stats.totalTokens': 'Total Tokens',
        'logs.request.status.all': 'All Status',
        'logs.request.status.running': 'Running',
        'logs.request.status.success': 'Success',
        'logs.request.status.error': 'Error',
        'logs.request.filters.provider': 'Filter by provider',
        'logs.request.filters.account': 'Filter by account',
        'logs.request.filters.search': 'Search requestId/model/path/error',
        'logs.request.table.detail': 'Detail',
        'logs.request.table.status': 'Status',
        'logs.request.table.account': 'Account',
        'logs.request.table.provider': 'Provider',
        'logs.request.table.model': 'Model',
        'logs.request.table.startedAt': 'Started',
        'logs.request.table.endedAt': 'Ended',
        'logs.request.table.duration': 'Duration',
        'logs.request.table.tokens': 'Tokens',
        'logs.request.table.retryCount': 'Retries',
        'logs.request.empty': 'No request logs',
        'logs.request.detail.requestId': 'Request ID',
        'logs.request.detail.path': 'Path',
        'logs.request.detail.clientIp': 'Client IP',
        'logs.request.detail.modelRequested': 'Requested Model',
        'logs.request.detail.modelActual': 'Actual Model',
        'logs.request.detail.upstreamStatus': 'Upstream Status',
        'logs.request.detail.tokens': 'Tokens (in/out/total)',
        'logs.request.detail.bytes': 'Bytes (req/res)',
        'logs.request.detail.fallback': 'Fallback',
        'logs.request.detail.error': 'Error',
        'logs.request.detail.noAttempts': 'No retry attempts',
        'logs.request.detail.attemptNo': 'Attempt',
        'logs.request.detail.startedAt': 'Started',
        'logs.request.detail.endedAt': 'Ended',
        'logs.request.detail.yes': 'Yes',
        'logs.request.detail.no': 'No',
